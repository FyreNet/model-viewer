...
export class SmoothControls extends EventDispatcher {
    ...
    get [(_a = $interactionEnabled, _b = $upQuaternion, _c = $upQuaternionInverse, _d = $spherical, _e = $targetSpherical, _f = $previousPosition, _g = $isUserChange, _h = $pointerIsDown, _j = $lastPointerPosition, _k = $velocity, $canInteract)]() {
